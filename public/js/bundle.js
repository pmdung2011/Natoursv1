...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(review, rating) {
    var slug, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Review successfully submitted!');
              setTimeout(function () {
...
var showReviewBtn = document.querySelector('.btn--show-review');
var reviewStars = document.querySelector('.reviews__rating-review');
var reviewSubmitBtn = document.querySelector('.btn--submit-review');
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _signup.signup)(name, email, password, passwordConfirm, passwordConfirm);
});
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btn--forgot-password').textContent = 'Sending email...';
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btn--reset-password').textContent = 'Validating...';
              password = document.getElementById('password').value;
              passwordConfirm = document.getElementById('passwordConfirm').value;
              resetToken = window.location.href.split('/')[4];
              _context3.next = 7;
              return (0, _login.resetPassword)(resetToken, password, passwordConfirm);
...
var addListenerToSubmitReview = function addListenerToSubmitReview() {
  reviewSubmitBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var reviewText = document.querySelector('.review__form-text').value;
    var reviewRating = stars.filter(function (star) {
      return star.classList.contains('reviews__star--active');
    });
    if (!reviewText || reviewRating.length === 0) return (0, _alerts.showAlert)('error', 'Please provide a review and a rating!');
    (0, _submitReview.submitReview)(reviewText, reviewRating.length);
  });
};

if (showReviewBtn) {
  showReviewBtn.addEventListener('click', function (e) {
    e.preventDefault();
...
var stars = Array.from(document.querySelectorAll('.reviews__star--big'));

if (reviewStars) {
  reviewStars.addEventListener('click', function (e) {
    var clicked = stars.indexOf(e.target);

    if (clicked >= 0) {
      stars.forEach(function (star, i) {
        star.classList = i > clicked ? 'reviews__star--big reviews__star--inactive' : 'reviews__star--big reviews__star--active';
      });
    }
  });
}
